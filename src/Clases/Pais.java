...
//        simulacion();
    ...
    private boolean vecinosOk() {
        gui.escribirEstado("PROTOCOLO: Iniciando Protocolo Ok paises en Pais "+ this.getNomPais()+"... ");
        ...
        if (vecinosAListos && vecinosTListos) {
            gui.escribirEstado("PROTOCOLO: Protocolo Ok paises en Pais "+ this.getNomPais()+" finalizó con exito, todos los vecinos estan conectados !!!");
            return true;
        }
        return false;
    }
    ...
    public void notificarCambio(String ip) {
        ...
        gui.escribirEstado("PROTOCOLO BALANCEO: "+nomPais+": Se detiene la simulación y se informa a los vecinos del cambio de host...");
    }
    ...
    public void simulacion() {
        ...
        while (((poblacion) > poblacionAislamiento) && Worker.isInterrupted() == false) {
            ...
            if (Worker.isInterrupted() == false && cont == 10) {
                ...
                notificarEstado();
                gui.escribirEstado("SIMULACIÓN: Pais "+ this.getNomPais()+" notificó estado a los vecinos !!! ");
                cont = 0;
            }
        }
        ...
        if (Worker.isInterrupted()) {
            ...
            System.out.println("Poblacion infectada vulnerable: " + poblacionInfectadaVulnerable);
            gui.actualizarPais(this);
            gui.escribirEstado("SIMULACIÓN: El pais "+ nomPais+ " ha terminado su simulación !!!");
        }
