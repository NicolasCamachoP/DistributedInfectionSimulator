    ...
    public void run() {
        try {
            ...
            if (m.tipo == Tipo.OkRequestPais) {
                ...
                pais.gui.escribirEstado(pais.getNomPais()+": se recibio información de cambio de host de "+dtoCambio.pNuevo+ " a la dirección: "+dtoCambio.ipNueva);
                ...
                Pais auxiliarP = (Pais)m.contenido;
                pais.gui.escribirEstado(pais.getNomPais()+": se recibió información del estado actual de "+auxiliarP.getNomPais()+
                        "\n"+"Población Infectada: "+auxiliarP.poblacionInfectada+
                        "\n"+"Población infectada vulnerable: "+auxiliarP.poblacionInfectadaVulnerable);
